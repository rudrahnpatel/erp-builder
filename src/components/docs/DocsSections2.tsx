    ...
    <section>
      ...
      <DocCards
        items={[
          ...
          { icon: <Hash className="h-5 w-5" />, title: "Number", desc: "Any numeric value, such as quantities, counts, or measurements." },
          ...
          { icon: <Link2 className="h-5 w-5" />, title: "Relation", desc: "Link a record to another table. For example, link an Invoice to a Customer record." },
