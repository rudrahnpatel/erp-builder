              ...
              >
                ...
                <form onSubmit={handleLoginSubmit} className="w-full max-w-[300px]">
                  ...
                  <div className="flex justify-between items-center w-full mt-8">
                    ...
                    <button
                      type="submit"
                      className="flex items-center justify-center rounded-full px-8 py-2.5 shadow-lg bg-blue-600 hover:bg-blue-700 transition-colors text-white text-sm font-medium" disabled={loading || !isLogin}>
                      Login
                      {loading && isLogin ? <Loader2 className="ml-2 h-4 w-4 animate-spin" /> : null}
                    </button>
                  </div>
              ...
              >
                ...
                <form onSubmit={handleRegisterSubmit} className="w-full max-w-[300px]">
                  ...
                  <div className="flex justify-end w-full mt-8">
                    <button
                      type="submit"
                      className="flex items-center justify-center rounded-full px-8 py-2.5 shadow-lg bg-blue-500 hover:bg-blue-600 transition-colors text-white text-sm font-medium" disabled={loading || isLogin}>
                      Sign Up
                      {loading && !isLogin ? <Loader2 className="ml-2 h-4 w-4 animate-spin" /> : null}
                    </button>
                  </div>
